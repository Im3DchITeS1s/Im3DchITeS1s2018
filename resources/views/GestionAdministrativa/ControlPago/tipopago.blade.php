...
@section('title', 'Control de Pago - Tipo Pago')
...
@section('content')
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="nombre_add" placeholder="ingresar tipo de pago" autofocus>
                                </div>                                             
                            </div>
                        </div>
                        ...
                        <div class="form-group has-warning">
                            ...
                            <div class="col-sm-11">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre_edit" placeholder="ingresar tipo de pago" autofocus>
                                </div>   
                            </div>
                        </div>                      
                    </form>
    ...
    //Edit
    $(document).on('click', '.edit-modal-tipo_pago', function() {                               
        ...
        $('#editModal').modal('show'); 
          ...
          $('.modal-footer').on('click', '.edit', function() {
            $.ajax({
                type: 'PUT',
                url: '/gestionadministrativa/controlpago/tipopago/' + id,
                data: {
                    '_token':   $('input[name=_token]').val(),
                    'id':       id,
        ...
        // delete
        $(document).on('click', '.delete-modal-tipo_pago', function() {
            id = $(this).data('id');
            swal({
              title: "Esta seguro?",
            ...
            .then((willDelete) => {
              if (willDelete) {
                $.ajax({
                    type: 'POST',
                    url: "/gestionadministrativa/controlpago/tipopago/cambiarEstado",
                    data: {
                        '_token': $('input[name=_token]').val(),
                        'id': id,
