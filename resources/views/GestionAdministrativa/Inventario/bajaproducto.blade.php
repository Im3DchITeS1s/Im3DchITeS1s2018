            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Baja Producto</h3>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#info-table').DataTable({
                processing: true,
                serverSide: false,
                ajax: '{!! route('bajaproducto.getdata') !!}',
                columns: [
                    { data: 'id', name: 'id' },
       ...
       $.get("/gestionadministrativa/inventario/bajaproducto/dropproducto/"+1,function(response,id){
        ...
        $('.modal-footer').on('click', '.add', function() {
            $.ajax({
                ...
                data: {
                    ...
                    'fkinventario_stock': $('#fkproducto_add').val(),
