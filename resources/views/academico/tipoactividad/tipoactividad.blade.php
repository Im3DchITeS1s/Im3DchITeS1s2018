...
@section('title', 'Mantenimiento - Tipo de Actividad')

@section('content_header')
    <div class="content-header">
        <h1>Tipo de Actividad
                        ...
                        <div class="form-group has-success">
                            <div class="col-sm-11">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="nombre_add" placeholder="Ingresar Actividad" autofocus>
                                </div>                                                               
                        ...
                        <div class="form-group has-warning">
                            ...
                            <div class="col-sm-11">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre_edit" placeholder="ingresar Actividad" autofocus>                         
                                </div> 
                                <p class="errorNombre text-center alert alert-danger hidden"></p>    
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#info-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('TipoActividad.getdata') !!}',
                columns: [
        ...
        $('.modal-footer').on('click', '.edit', function() {
            $.ajax({
                type: 'PUT',
                url: '/academico/tipoactividad/' + id,
                data: {
                    '_token': $('input[name=_token]').val(),
                    'id': $("#id_edit").val(),
        ...
        $(document).on('click', '.delete-modal', function() {
            ...
            .then((willDelete) => {
              if (willDelete) {
                $.ajax({
                    type: 'POST',
                    url: "/academico/tipoactividad/cambiarEstado",
                    data: {
                        '_token': $('input[name=_token]').val(),
                        'pktipoactividad': id,
