...
@section('title', 'Mantenimiento - Tipo Compania')
...
@section('content_header')
	<div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tipo Compania</li>
        </ol>                      
	</div>    
@stop
        ...
        $(document).on('click', '.delete-modal', function() {
            ...
            .then((willDelete) => {
              if (willDelete) {
                $.ajax({
                    type: 'POST',
                    url: "/mantenimiento/compania/cambiarEstado",
                    data: {
                        '_token': $('input[name=_token]').val(),
                        'pkprofesion': $(this).data('id'),
