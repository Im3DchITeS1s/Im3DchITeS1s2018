...
@section('title', 'Mantenimiento - Profesión')
                        ...
                        <div class="form-group has-success">
                            <div class="col-sm-11">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="nombre_add" placeholder="Ingresar la Profesión" autofocus>
                                </div>                                                               
