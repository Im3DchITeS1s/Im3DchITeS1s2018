...
@section('title', 'Mantenimiento - Tipo Persona')
                        ...
                        <div class="form-group has-success">
                            <div class="col-sm-11">
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" id="nombre_add" placeholder="Ingresar tipo de Persona" autofocus>
                                </div>                                        
                        ...
                        <div class="form-group has-warning">
                            <div class="col-sm-11">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre_edit" placeholder="Editar tipo de Persona" autofocus>                         
                                </div> 
                                <p class="errorNombre text-center alert alert-danger hidden"></p>    
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#info-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('tipopersona.getdata') !!}',
                columns: [
        ...
        $('.modal-footer').on('click', '.edit', function() {
            $.ajax({
                type: 'PUT',
                url: '/mantenimiento/tipopersona/' + id,
                data: {
                    '_token': $('input[name=_token]').val(),
                    'id': $("#id_edit").val(),
        ...
        $(document).on('click', '.delete-modal', function() {
            ...
            .then((willDelete) => {
              if (willDelete) {
                $.ajax({
                    type: 'POST',
                    url: "/mantenimiento/tipopersona/cambiarEstado",
                    data: {
                        '_token': $('input[name=_token]').val(),
                        'pkprofesion': id,
