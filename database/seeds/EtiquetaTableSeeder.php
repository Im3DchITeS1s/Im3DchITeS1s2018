...
class EtiquetaTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	$insert->tipo = 'check';
        $insert->color = 'clouds';
    	$insert->metadata_inicio = '<div class="icheck-clouds icheck-inline"><input type="checkbox"';
    	...
    	$insert->metadata_inicio = '<div class="icheck-default icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';   	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
    	...
    	$insert->metadata_inicio = '<div class="icheck-primary icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';   	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
    	...
    	$insert->metadata_inicio = '<div class="icheck-success icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';   	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
        ...
        $insert->tipo = 'check';
        $insert->color = 'info';
    	$insert->metadata_inicio = '<div class="icheck-info icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';  	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
    	...
    	$insert->metadata_inicio = '<div class="icheck-warning icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';   	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
        ...
        $insert->tipo = 'check';
        $insert->color = 'danger';
    	$insert->metadata_inicio = '<div class="icheck-danger icheck-inline"><input type="checkbox"';
    	$insert->idetiqueta = ' id="';
        $insert->nameetiqueta = '" name="';    	
        $insert->cierreetiqueta = '" />';
        $insert->metadata_cierra = '</div>';
